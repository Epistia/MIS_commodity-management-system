...
constexpr auto qt_meta_stringdata_CLASSregistENDCLASS = QtMocHelpers::stringData(
    ...
    "",
    "on_back_regsPushButton_clicked"
);
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSregistENDCLASS_t qt_meta_stringdata_CLASSregistENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(7, 29),  // "on_registerPushButton_clicked"
        QT_MOC_LITERAL(37, 0),  // ""
        QT_MOC_LITERAL(38, 30)   // "on_back_regsPushButton_clicked"
    },
    "regist",
    "on_registerPushButton_clicked",
    "",
...
Q_CONSTINIT const QMetaObject regist::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSregistENDCLASS_t,
        ...
        // method 'on_back_regsPushButton_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void regist::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_back_regsPushButton_clicked(); break;
        default: ;
        }
    }
    (void)_a;
